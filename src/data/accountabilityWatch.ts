export type AccountabilityItem = {
  ...
  title: string;  // "Accountability Watch — March 2026 Roundup"
  slug: string;   // "2026-04-01"
  summary: string;
  path: string;   // "/resources/accountability-watch/2026-04-01"
};
...
export const accountabilityWatch: AccountabilityItem[] = [
{
  ...
  slug: "2026-08-01",
  path: "/resources/accountability-watch/2026-08-01",
  summary:
    "July 2026 accountability cases centered on educators, school administrators, youth ministers, clergy, youth-sports coaches, Scouting leadership, law-enforcement and corrections personnel, healthcare and juvenile-detention authority, household control, technology and business legitimacy, celebrity/public-profile influence, and institutional-accountability findings. Across the month, risk emerged through trusted roles, custody, professional authority, household dependency, institutional legitimacy, wealth/status access, and public influence rather than through registry-centered warning assumptions.",
},
{
  date: "2026-07-01",
  ...
  summary:
    "June 2026 accountability cases centered on educators, school administrators, youth-sports coaches, law-enforcement personnel, clergy, foster/adoptive and caregiver authority, medical and military status, civic leadership, and institutional-accountability findings. Across the month, risk emerged through trusted roles, household control, public authority, institutional legitimacy, and status-based access rather than through registry-centered warning assumptions.",
},
{
  date: "2026-06-01",
...
},
{
  ...
  // Newest-first: add future monthly roundups ABOVE this line.
