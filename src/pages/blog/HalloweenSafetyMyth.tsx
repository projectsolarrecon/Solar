...
<BandHeader title="Evidence at a Glance" icon="📊" />
    ...
    <p className="mt-6">These policies reveal how far the regulatory impulse extends: enforced silence, prohibition of expression, monitoring of private property—framed as child protection despite the absence of actual registry-linked harm.</p>
