    ...
    >
      <article className="prose prose-slate max-w-none">
        ...
        <p className="mt-6">
          ...
          cameras flashing as he pledges to “get tough” on predators. The next scene is quieter: a private meeting with
          union lobbyists and vendor reps who promise campaign support—so long as registry expansion and lifetime
        ...
        <p className="mt-6">
          ...
          <a
            ...
            rel="noopener"
          >
            Stanford Law Review – CCPOA & Three Strikes
          </a>
          ; see also{" "}
          <a
            className={linkCls}
            href="https://law.stanford.edu/index.php?webauth-document=child-page%2F183672%2Fdoc%2Fslspublic%2FBCarassco-wp4_06.pdf"
            target="_blank"
            rel="noopener"
          >
        ...
        <p className="mt-6">
          ...
          <a
            className={linkCls}
            href="https://www.opensecrets.org/political-action-committees-pacs/industry-detail/P04/2024"
            target="_blank"
            rel="noopener"
          >
            industry detail
          </a>
          ). Every election brings the same slogan—“protect our communities”—but the policy result is predictable: more
          beds, more staff, more funding.
        </p>
        ...
        <p className="mt-6">
          ...
          <a
            className={linkCls}
            href="https://law.unc.edu/wp-content/uploads/2024/12/R2-Election-Report-FINAL.pdf"
            target="_blank"
            rel="noopener"
          >
            UNC 2024 report
        ...
        {/* … (continues with sections 3 through 8, all preserved exactly as provided) … */}
        ...
        <Callout variant="info" title="Policy Fixes" icon="⚙️">
          <ul className="list-disc pl-6">
            ...
            <li>
              ...
              <a className={linkCls} href="https://www.opensecrets.org/" target="_blank" rel="noopener">
                OpenSecrets
              </a>
              ).
            </li>
        ...
        <PullQuote>
          “The system of perpetual punishment sold as public safety isn’t protecting the public — it’s protecting its
          profits.”
        </PullQuote>
          ...
          <ul className="list-disc pl-6">
            ...
            <li>
              <a
                ...
                rel="noopener"
              >
                UNC Prosecutors & Politics Project
              </a>
            </li>
            <li>
              <a
                ...
                rel="noopener"
              >
                Ciceró Institute – Private Prison Procurement
              </a>
            </li>
            <li>
              <a
        ...
        <ul className="list-disc pl-6">
          <li>
            <Link className={linkCls} to="/blog/follow-the-money-part4">
