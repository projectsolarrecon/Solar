...
export default function ResidencyRestrictionsHousing(): JSX.Element {
  return (
    <BlogLayout
      ...
      <article className="prose prose-slate max-w-none">
        <Callout variant="info" title="TL;DR" icon="🔎">
          <p>
            ...
            <Link className={linkCls} to="/resources/legislative-advocacy">Legislative Advocacy Guide</Link>.
          </p>
        </Callout>
