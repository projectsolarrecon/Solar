      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <article
          className="
            ...
            [&_p]:mt-6
            [&_h2]:mt-12 [&_h2]:scroll-mt-24 [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:font-semibold [&_h2]:text-slate-900
            [&_blockquote]:mt-8 [&_blockquote]:border-l-4 [&_blockquote]:border-slate-300 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-slate-700
            [&_a]:underline [&_a]:decoration-sky-400 [&_a:hover]:decoration-sky-600 [&_a]:underline-offset-2 [&_a]:break-words
            [&_ul]:mt-6 [&_ul]:space-y-3 [&_li]:pl-0
          "
        >
          {/* Intro */}
          <section>
            ...
            <p>
              But in the federal criminal system — and in many state systems as well — the term “violent” has expanded
              far beyond its intuitive meaning. A college student who downloads the wrong images, a middle-aged man who
              exchanges inappropriate messages with a teenager online, or someone who possesses illegal files without
              ever contacting another human being: all can be classified in the eyes of the law as “violent” offenders.
            </p>
            <p>
          ...
          {/* Extra Callout for disparity */}
          <section className="rounded-2xl border border-red-200 bg-red-50 px-6 py-5">
            <div className="flex items-start gap-3">
              <span className="text-xl" aria-hidden>📊</span>
              <p className="m-0 text-slate-800">
                Data reveal stark disparities: nonviolent possession can trigger longer sentences than robbery,
                aggravated assault, or even manslaughter—often with fewer opportunities for early release.
              </p>
            </div>
          </section>
          ...
          {/* Extra Callout: human consequences */}
          <section className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-5">
            <div className="flex items-start gap-3">
              <span className="text-xl" aria-hidden>💡</span>
              <p className="m-0 text-slate-800">
                The consequences are not abstract—they destroy families, destabilize communities, and leave society
                managing people shaped by prison survival rather than rehabilitation.
              </p>
            </div>
          </section>

          {/* Sources */}
          <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 mt-12">
