  ...
  return (
    ...
    >
      <article className="prose prose-slate max-w-none">
        ...
        <p><em>(Part I of II: The Kiddie Stroll)</em></p>
        ...
        <p>A map of red dots is easier to sell than the truth.</p>
        ...
        <p>And still — there is almost no enforcement presence.</p>
        ...
        <p>Budget cuts, officials said.</p>
        ...
        <p>
          One detective for what the <em>Times</em> described — and the{" "}
          <a
            className={linkCls}
            href="https://www.facebook.com/nytimes/photos/los-angeles-is-home-to-one-of-the-most-notorious-sex-trafficking-corridors-in-th/1211837074132087/"
            target="_blank"
            rel="noopener"
          >
            New York Times’s own social media promotion
          </a>{" "}
          emphasized — as one of the “most notorious sex-trafficking corridors” in the United States.
        </p>
...
<p>
        ...
        <p>
          And what did the county do afterward?
        </p>

        <p>It <strong>did not rebuild</strong> its anti-trafficking infrastructure.</p>
        <p>It <strong>did not increase</strong> child-protection staffing in a way that’s visible to the public.</p>
        <p>It <strong>did not expand</strong> oversight or independent safeguards at the scale of the harm.</p>

        <p>It <strong>did not</strong> restore the LAPD human-trafficking unit.</p>
        <p>It <strong>did not</strong> fill the five vacant vice-investigator positions in 77th Street Division.</p>

        <p>It left Figueroa Street with one detective.</p>
...
<p>
        ...
        <p>
          And that is the most damning fact of all.
        </p>
