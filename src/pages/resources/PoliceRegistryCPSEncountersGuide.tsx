        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              ...
              is maintained and rechecked; recording rules can change and often
              depend on state law, setting, audio capture, privacy expectations,
              and supervision or device restrictions.
            </p>
        ...
        <GuideSectionCard>
          <ResourceLinkGrid
            ...
            resources={[
              ...
              {
                label: "Georgia DFCS: safety plan policy example",
                href: sourceLinks.georgiaSafetyPlan,
                badge: "Official state example",
                description:
                  "State child-welfare policy example showing how safety planning is handled in one jurisdiction.",
              },
              {
                label: "Missouri DSS: investigations and law-enforcement coordination example",
                href: sourceLinks.missouriInvestigations,
                badge: "Official state example",
                description:
          ...
          <SourceList
            ...
            note={
              <span>
                Sources were selected for authority and specificity. Links
                should be rechecked during final production QA, and state law,
            ...
            sources={[
              ...
              {
                label: "United States v. Knights",
                href: sourceLinks.knights,
                description:
                  "Supports the narrow proposition that Knights involved a warrantless search supported by reasonable suspicion and a probation search condition.",
              },
              {
              ...
              {
                label: "Georgia DFCS Child Welfare Policy Manual: safety plan policy",
                href: sourceLinks.georgiaSafetyPlan,
                description:
                  "Provides an official state example of safety-planning policy and documentation requirements.",
              },
              {
                label: "Missouri DSS Child Welfare Manual: investigations",
                href: sourceLinks.missouriInvestigations,
                description:
                  "Provides an official state example of child-welfare investigations and law-enforcement coordination.",
              },
              {
                label: "Reporters Committee: recording guide",
                href: sourceLinks.rcfpRecordingGuide,
