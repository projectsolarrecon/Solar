    ...
    >
      ...
      <SectionCard>
        ...
        <p className="text-slate-700">
          ...
          Adam Walsh Act (SORNA). Each state implements these rules differently; this hub helps you
          understand common threads and your state-specific obligations.
        </p>
      ...
      <SectionCard>
        ...
        <div className="space-y-4">
          <Callout variant="info" title="NARSOL">
            <p>
              The National Association for Rational Sexual Offense Laws: state guides, legal referrals,
              and advocacy. <a href="https://www.narsol.org/" target="_blank" rel="noopener">narsol.org</a>
            </p>
          </Callout>
          <Callout variant="info" title="ACSOL / ALL4CONSOLAWS">
            <p>
              Alliance for Constitutional Sex Offense Laws: legal support and education in multiple states.
              <a href="https://all4consolaws.org/" target="_blank" rel="noopener">all4consolaws.org</a>
            </p>
          </Callout>
          <Callout variant="info" title="CURE National">
            <p>
              Criminal justice reform and reentry resources.
      ...
      <SectionCard>
        ...
        <p className="text-slate-700 mb-4">
          Tasks every registrant should consider — check your state page for exact deadlines:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-slate-700">
          ...
          <li>After change of address, job, school: update your registration record immediately.</li>
          <li>Keep records (stamped receipts, proof of mailing, screenshots) in case of disputes.</li>
        </ul>
      </SectionCard>
      ...
      <SectionCard>
        ...
        <Callout variant="research" title="Did You Know?">
          <p>
            Some studies show registrants have among the lowest recidivism rates of any felony group.
            The U.S. Sentencing Commission and Bureau of Justice Statistics publish relevant analyses.
          </p>
          <p>
      ...
      <footer className="mt-8 text-xs text-slate-500 border-t border-slate-200 pt-4">
        <p>
          🤝 This hub combines official statutes, state registry codes, and AI-assisted research.
          We strive for clarity and accuracy — if you see something out of date, please let us know.
        </p>
