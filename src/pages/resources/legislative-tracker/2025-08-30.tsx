    ...
    <div className="bg-white">
      ...
      <section id="glance" className="mt-8">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <ul className="space-y-2 text-slate-800">
            <li>🏛️ <strong>Federal:</strong> U.S. Sentencing Commission adopted supervised-release changes (effective <strong>Nov 1, 2025</strong>) shaping internet/device rules and responses to violations. <a className="underline" href="https://www.ussc.gov/guidelines/amendments/adopted-amendments-effective-november-1-2025" target="_blank" rel="noreferrer">USSC amendments</a></li>
            <li>🗺️ <strong>States:</strong> PA (Act 22) adds youth-sports/nonprofit abuse to Tier II; TN centralizes classifications; AR expands “no-go” zones and adds juvenile fee waiver; FL passed a broad update effective Oct 1; UT recodified registry statutes; WV adjusted administrative fees.</li>
            <li>⚖️ <strong>Cases:</strong> OK upheld retroactive park-distance rule; MO upheld lifetime GPS in an as-applied challenge; 10th Cir okayed strict device/internet limits; 6th Cir said TN injunctions must target specific provisions.</li>
            <li>📣 <strong>Action:</strong> Florida CS/HB 1351 implementation ahead of Oct 1; track Michigan SB 424 hearings; watch WA SB 5312 re-intro in 2026.</li>
          </ul>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          ...
          <article className="rounded-2xl border border-slate-200 shadow-sm">
            <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white rounded-t-2xl px-5 py-3 flex items-center gap-2">
              <span role="img" aria-label="federal">🏛️</span>
              <h3 className="text-lg md:text-xl font-semibold">U.S. Sentencing Commission — Supervised-Release Changes</h3>
            </div>
            <div className="p-5">
              ...
              <div className="mt-4 rounded-xl bg-slate-50 border border-slate-200 p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    onClick={() => copyText('script-ussc', 'Hello — please support fair, individualized supervised-release technology conditions and oversight. Clear rules help families succeed while keeping communities safe.')}
          ...
          <article className="rounded-2xl border border-slate-200 shadow-sm">
            <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white rounded-t-2xl px-5 py-3 flex items-center gap-2">
              <span role="img" aria-label="state">🏷️</span>
              <h3 className="text-lg md:text-xl font-semibold">Florida — CS/HB 1351 (Signed; Effective Oct 1, 2025)</h3>
            </div>
            <div className="p-5">
              ...
              <div className="mt-4 rounded-xl bg-slate-50 border border-slate-200 p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    onClick={() => copyText('script-fl', 'Hello — I’m seeking clear, accessible guidance for CS/HB 1351 before Oct 1 so families can comply without surprise. Please publish plain-language FAQs and timelines.')}
                    className="text-sm rounded-lg px-3 py-1 ring-1 ring-slate-300 hover:bg-slate-100"
                  >
          ...
          <article className="rounded-2xl border border-slate-200 shadow-sm">
            <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white rounded-t-2xl px-5 py-3 flex items-center gap-2">
              ...
              <h3 className="text-lg md:text-xl font-semibold">Case Watch — Doe v. Lee (6th Cir., Tennessee)</h3>
            </div>
            <div className="p-5">
              <p><strong>ELI5:</strong> The appeals court said Tennessee courts can’t block the <em>entire</em> registry at once; any injunction must target <em>specific</em> rules shown to be punitive.</p>
              ...
              <div className="mt-4 rounded-xl bg-slate-50 border border-slate-200 p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    onClick={() => copyText('script-tn', 'I’m interested in supporting provision-specific challenges after Doe v. Lee. Please keep me posted on amicus opportunities and what documentation helps most.')}
                    className="text-sm rounded-lg px-3 py-1 ring-1 ring-slate-300 hover:bg-slate-100"
                  >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          ...
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Act 158 (HB 1437)</strong> — Expands “no-go” zones to water parks, swimming areas, and playgrounds in public parks. <a className="underline" href="https://arkleg.state.ar.us/Acts/FTPDocument?ddBienniumSession=2025%2F2025R&file=158.pdf&path=%2FACTS%2F2025R%2FPublic%2F" target="_blank" rel="noreferrer">Act PDF</a> · <a className="underline" href="https://arkleg.state.ar.us/Bills/Detail?ddBienniumSession=2025%2F2025R&id=HB1437" target="_blank" rel="noreferrer">Bill page</a></li>
              <li><strong>Act 972 (SB 490)</strong> — Allows courts to waive certain fees when a juvenile is ordered to register. <a className="underline" href="https://arkleg.state.ar.us/Acts/FTPDocument?ddBienniumSession=2025%2F2025R&file=972.pdf&path=%2FACTS%2F2025R%2FPublic%2F" target="_blank" rel="noreferrer">Act PDF</a></li>
            </ul>
          </article>
          ...
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <p><strong>SB 5312</strong> — “Net-Nanny” sting cases: proposed 5-year registration (with limited public notice) if no sexual-motivation finding; <em>did not move</em> in 2025.</p>
      ...
      <section id="cases" className="mt-4">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          ...
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <p><strong>ELI5:</strong> The state high court said the 2,000-ft park rule can apply retroactively because it’s considered non-punitive.</p>
            <div className="mt-3 rounded-xl bg-blue-50 text-blue-900 p-4">
              <div className="font-medium">Why it matters</div>
              <ul className="list-disc pl-6 space-y-1">
          ...
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <p><strong>ELI5:</strong> The court upheld lifetime GPS monitoring in this case because the person didn’t show enough specific proof that GPS was unconstitutional <em>for them</em>.</p>
          ...
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <p><strong>ELI5:</strong> Injunctions must be tailored to specific provisions of the registry shown to be punitive; no blanket “shut the whole thing down” orders.</p>
      ...
      <section id="research" className="mt-4">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><a className="underline" href="https://smart.ojp.gov/sites/g/files/xyckuh231/files/media/document/SORNA%20progress%20check%2005212025.pdf" target="_blank" rel="noreferrer">SORNA Progress Check (May 2025) — PDF</a></li>
              <li><a className="underline" href="https://smart.ojp.gov/funding/opportunities/o-smart-2025-172307" target="_blank" rel="noreferrer">FY25 AWA Implementation Grant — NOFO</a></li>
      ...
      <section id="media" className="mt-4">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            <ul className="list-disc pl-6 space-y-1">
              <li>Oklahoma — <a className="underline" href="https://nondoc.com/2025/02/07/divided-ok-supreme-court-rules-sex-offender-residency-restriction-can-be-retroactive/" target="_blank" rel="noreferrer">NonDoc explainer on <em>Donaldson</em></a></li>
              <li>Missouri — <a className="underline" href="https://www.missourinet.com/2025/02/12/missouri-supreme-court-rules-in-case-challenging-lifetime-monitoring-of-sex-offender/" target="_blank" rel="noreferrer">Missourinet recap of <em>F.S.</em></a></li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section id="watchlist" className="mt-4 mb-12">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid gap-6">
          <article className="rounded-2xl border border-slate-200 p-5 shadow-sm">
            <ul className="list-disc pl-6 space-y-1">
              <li><strong>Florida — CS/HB 1351:</strong> Implementation ahead of <strong>Oct 1, 2025</strong>. <a className="underline" href="https://www.flsenate.gov/Session/Bill/2025/1351" target="_blank" rel="noreferrer">Bill page</a></li>
              <li><strong>Michigan — SB 424:</strong> Track committee/floor actions. <a className="underline" href="https://www.legislature.mi.gov/documents/2025-2026/billanalysis/Senate/pdf/2025-SFA-0424-F2.pdf" target="_blank" rel="noreferrer">Latest SFA analysis</a></li>
              <li><strong>Washington — SB 5312:</strong> Potential 2026 re-intro. <a className="underline" href="https://lawfilesext.leg.wa.gov/biennium/2025-26/Pdf/Bill%20Reports/Senate/5312%20SBR%20LAW%20TA%2025.pdf" target="_blank" rel="noreferrer">Bill report</a></li>
              <li><strong>Oklahoma — post-<em>Donaldson</em>:</strong> Watch new challenges to other SORA provisions.</li>
            </ul>
          </article>
        </div>
      </section>
