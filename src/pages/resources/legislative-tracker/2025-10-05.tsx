  ...
  return (
    <div className="bg-white">
      <SEO
        ...
        description="Weekly roundup of U.S. registry and policy activity — buffer zone proposals in NY, SMART grant updates, and enforcement alerts."
      />
      ...
      <section className="bg-white rounded-2xl shadow p-6 border border-slate-200">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1 text-emerald-900/90">
              <li><span className="font-medium">Bee Cave (TX) Ordinance</span> — 2,000 ft child-safety buffer + Halloween rules now active.</li>
            </ul>
          </div>
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1 text-amber-900/90">
              <li><span className="font-medium">NY S-(TBD)</span> — Statewide 1,500 ft school/playground residence buffer proposal in committee (Crime Victims & Correction).</li>
            </ul>
          </div>
          <div className="rounded-xl border border-sky-200 bg-sky-50 p-4">
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1 text-sky-900/90">
              <li><span className="font-medium">SMART Office</span> — FY 25 Adam Walsh Act Implementation Grant webinar and NOFO open for applications.</li>
              <li><span className="font-medium">Delaware State Police SOAR Unit</span> — ongoing public alert for wanted non-registrants (Oct 3 release).</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-lg border border-slate-200 p-4">
            <p className="text-sm text-slate-700"><span className="font-semibold">Gaps this week:</span> No new federal bills or major court opinions on registry reform.</p>
          </div>
          <div className="rounded-lg border border-slate-200 p-4">
            <p className="text-sm text-slate-700"><span className="font-semibold">What’s ahead:</span> Track NY committee schedule and SMART grant deadlines for FY 25 applications.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-2xl shadow p-6 border border-slate-200 mt-8" id="highlights">
        ...
        <div className="space-y-4 text-slate-800">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            ...
            <p className="text-sm">Local and state leaders seek a law barring Level 2 & 3 offenders from living within 1,500 ft of schools or playgrounds; awaiting committee review.</p>
            ...
            <div className="mt-3 flex flex-wrap gap-2 print:hidden">
              <a href="https://www.timesunion.com/" target="_blank" rel="noreferrer"
                 className="inline-flex items-center gap-2 rounded-lg bg-slate-900 text-white px-3 py-2 text-sm">Look up your rep</a>
              <button onClick={() => copy('SCRIPT-NY-BUFFER')}
                className="inline-flex items-center gap-2 rounded-lg bg-amber-600 text-white px-3 py-2 text-sm">Copy call script</button>
            </div>
            <textarea id="SCRIPT-NY-BUFFER" className="sr-only" readOnly value={`Hello, I'm a New York constituent concerned about the proposed 1,500 ft buffer. Evidence shows large buffers reduce housing stability and do not improve safety. Please ensure any bill is data-driven and includes reentry protections.`} />
          </div>

          {/* Highlight 2 — SMART grant guidance */}
          <div className="rounded-xl border border-sky-200 bg-sky-50 p-4">
            <p className="font-semibold">DOJ SMART Office — FY 25 Adam Walsh Act Grant Guidance</p>
            <p className="text-sm">The SMART Office released a webinar and NOFO for jurisdictions to support SORNA implementation and interstate coordination.</p>
            <div className="mt-2 flex flex-wrap gap-2 text-[12px]">
            ...
            <div className="mt-3 flex flex-wrap gap-2 print:hidden">
              ...
              <button onClick={() => copy('SCRIPT-SMART-GRANT')}
                className="inline-flex items-center gap-2 rounded-lg bg-sky-600 text-white px-3 py-2 text-sm">Copy outreach script</button>
            </div>
            <textarea id="SCRIPT-SMART-GRANT" className="sr-only" readOnly value={`Hello, I'm sharing the FY 25 SMART grant NOFO link for jurisdiction teams. Please review eligibility and deadlines for SORNA compliance funding: https://smart.ojp.gov/funding`} />
          </div>

          {/* Highlight 3 — Delaware enforcement alert */}
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
            <p className="font-semibold">Delaware State Police — SOAR Unit Enforcement Alert</p>
            <p className="text-sm">SOAR issued a public “wanted offenders” list for non-registrants and urged tips from the community (Oct 3 update).</p>
            <div className="mt-2 flex flex-wrap gap-2 text-[12px]">
            ...
            <div className="mt-3 flex flex-wrap gap-2 print:hidden">
              <a href="https://dsp.delaware.gov/soar-unit/" target="_blank" rel="noreferrer"
                 className="inline-flex items-center gap-2 rounded-lg bg-slate-900 text-white px-3 py-2 text-sm">Official alert</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white rounded-2xl shadow p-6 border border-slate-200 mt-8">
        ...
        <p className="text-sm text-slate-700">No new decisions this week. Carry-forward: <em>Donaldson v. City of El Reno</em> (OK Sup Ct Feb 4 2025) — retroactive 2,000 ft residency buffer upheld (subject to future appeals).</p>

        <h3 className="text-xl font-semibold mt-6 mb-2">🗳️ Ballot Measures & Agency Updates</h3>
        <ul className="list-disc pl-5 text-sm text-slate-700 space-y-1">
          <li>SMART Office NOFO active for FY 25 applications — SORNA implementation support.</li>
          <li>Delaware SOAR unit public alert (Oct 3).</li>
        </ul>

        <h3 className="text-xl font-semibold mt-6 mb-2">📰 Media Coverage</h3>
        <ul className="list-disc pl-5 text-sm text-slate-700 space-y-1">
          <li><em>Times Union:</em> “Rensselaer County leaders call for state residency limits for sex offenders.” (<Link to="https://www.timesunion.com/" className="text-blue-700 underline">source</Link>)</li>
          <li><em>Statesman:</em> “Bee Cave passes sex offender residency restrictions.” (<Link to="https://www.statesman.com/" className="text-blue-700 underline">source</Link>)</li>
        </ul>
...
export const teasers = {
  ...
  highlights: [
    { icon: '🟠', title: 'New York – 1,500 ft Buffer Bill Introduced', url: 'https://www.timesunion.com/' },
    { icon: '🔵', title: 'SMART Office FY 25 Grant Webinar & NOFO', url: 'https://smart.ojp.gov/funding' },
    { icon: '🟢', title: 'Delaware SOAR Unit Enforcement Alert', url: 'https://dsp.delaware.gov/soar-unit/' },
  ],
};