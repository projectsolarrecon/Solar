...
export default function JobSearchGuide(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      <SEO
        title="Employment Strategies for People on Sex Offender Registries | The SOLAR Project"
        description="A practical, sex-offense-specific employment guide for people with sex offense convictions, registry requirements, or both."
        keywords="sex offender registry employment, how to find a job on sex offender registry, sex offense registry employment, registrant job search, reentry employment, fair chance hiring, background check rights, SOLAR Project"
      />
      ...
      <section className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 text-white py-12 sm:py-16 no-print">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-lg sm:text-xl text-slate-100 leading-relaxed">
            ...
            convictions, registry requirements, or both.
          </p>
