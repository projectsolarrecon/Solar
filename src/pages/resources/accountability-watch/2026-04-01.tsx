...
function SubgroupDivider({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex items-center gap-3 py-1">
      <div className="h-px flex-1 bg-slate-200" />
      <div className="rounded-full border border-slate-300 bg-slate-100 px-4 py-1.5 text-xs font-black uppercase tracking-[0.18em] text-slate-700 shadow-sm">
        {children}
      </div>
      <div className="h-px flex-1 bg-slate-200" />
    </div>
...
function CaseRow({
  ...
  return (
    <article className="rounded-2xl border border-slate-300 bg-gradient-to-br from-white to-slate-50 p-5 shadow-sm ring-1 ring-slate-100">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="flex gap-3">
          <div
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-white text-2xl shadow-sm"
            aria-hidden="true"
          >
            {emoji}
          </div>
          <div>
            <h3 className="text-lg font-black tracking-tight text-slate-950">{name}</h3>
            <p className="mt-0.5 text-sm font-medium text-slate-700">{role}</p>
          </div>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-left shadow-sm md:text-right">
      ...
      <div className="mt-4 border-t border-slate-200 pt-4 text-sm leading-6 text-slate-800">
        {summary}
      </div>
...
<div className="mt-6 rounded-2xl border border-white/15 bg-white/10 p-4 text-sm leading-6 text-slate-100">
        ...
        <div className="mx-auto max-w-6xl space-y-6 px-4 py-8 md:px-6">
          <Section title="At a Glance" eyebrow="March patterns">
            <div className="overflow-hidden rounded-2xl border border-slate-300 bg-slate-950 shadow-sm">
              <div className="grid gap-px bg-slate-800 md:grid-cols-3">
                <div className="bg-slate-950 p-5 text-white">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-100">
                    March’s approved set was dominated by education and youth-access roles,
                    including teachers, school employees, coaches, and youth ministers.
                  </p>
                </div>
                <div className="bg-slate-950 p-5 text-white">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-400">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-100">
                    The strongest arrest and charge pattern involved school access,
                    including classroom, school-athletics, and campus-linked allegations.
                  </p>
                </div>
                <div className="bg-slate-950 p-5 text-white">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-400">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-100">
                    Institutional accountability remained central, with the Rhode Island
                    Diocese report, El Monte Union settlement, and Oconto Falls lawsuit
                    anchoring the oversight-failure set.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-5 shadow-sm">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  {teaserHighlights.map((item) => (
                    <div
                      key={item}
                      className="rounded-xl border border-slate-200 bg-white p-4 text-sm leading-6 text-slate-800 shadow-sm"
                    >
                      {item}
                    </div>
                  ))}
          ...
          <Section title="New Arrests & Charges" eyebrow="School access and youth-facing roles">
            <SubgroupDivider>Education / youth sports</SubgroupDivider>
            ...
            <SubgroupDivider>Education</SubgroupDivider>
          ...
          >
            <SubgroupDivider>Other institutional authority / wealth and public influence</SubgroupDivider>
            ...
            <SubgroupDivider>Clergy / religious institutions</SubgroupDivider>
...
<SubgroupDivider>Education</SubgroupDivider>
            ...
            <SubgroupDivider>Youth sports / youth groups</SubgroupDivider>
            ...
            <SubgroupDivider>Law enforcement / corrections</SubgroupDivider>
            ...
            <SubgroupDivider>Healthcare / therapy</SubgroupDivider>
