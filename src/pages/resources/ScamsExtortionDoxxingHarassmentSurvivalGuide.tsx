...
const sourceLinks = {
  ...
  facebookReport: "https://www.facebook.com/help/212722115425932/",
  tiktokReportIllegal:
...
const sources = [
  ...
  },
  {
    ...
    href: sourceLinks.ftcRefundRecoveryScams,
    description:
      "Supports warnings about upfront-fee promises, impostors claiming professional or government affiliation, and pay-us-to-fix-it scam patterns. It does not decide registry-relief eligibility.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Supports the warning that scammers may impersonate law enforcement, spoof caller ID, demand payment, and pressure people to act immediately.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Legal-help finder for locating LSC-funded civil legal aid organizations by address or city.",
  },
  {
    label: "American Bar Association — Find Legal Help",
    href: sourceLinks.abaFindLegalHelp,
    description:
      "Public legal-help directory, including lawyer licensing and lawyer-referral resources.",
  },
  {
  ...
  },
  {
    ...
    description: "Platform-specific reporting process for X.",
  },
  {
    label: "Facebook Help Center — Report abusive things",
    href: sourceLinks.facebookReport,
    description:
      "Platform-specific reporting process for Facebook. This page may require normal Facebook access or login behavior.",
  },
  {
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <GuideIntro title="Start here" icon="🧭">
          ...
          <p>
            ...
            The safest first move is still usually the same: slow down,{" "}
            <ExternalGuideLink href={sourceLinks.ftcGovernmentImpersonators}>
              verify official-sounding contact independently
            </ExternalGuideLink>
            , preserve evidence, secure what can be secured, and choose the
            right reporting path.
          </p>
        ...
        <QuickStartPanel
          ...
          nextActions={[
            ...
            <span>
              ...
              <InternalGuideLink to="/resources/supervision-conditions-guide">
                supervision or device-monitoring conditions
              </InternalGuideLink>{" "}
              before changing technology.
            </span>,
            <span>
              <strong>Report in the right lane.</strong> Local threats,
              stalking, and vandalism may need local law enforcement.{" "}
              <ExternalGuideLink href={sourceLinks.ic3Complaint}>
                Internet-enabled fraud
              </ExternalGuideLink>{" "}
              may belong with IC3. Consumer scams may belong with the FTC.
        ...
        <OverviewCards
          ...
          cards={[
            ...
            },
            {
              ...
              tone: "family",
              description:
                "A harasser contacts your family, employer, landlord, school, church, treatment provider, neighbor, or support network.",
            },
            {
              eyebrow: "Lane 6",
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              ...
              reposted, purchased, guessed, or shared by someone else. Knowing               something true about you does not prove the person is legitimate.
            </p>
          </GuideProse>
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              If a suspicious call mentions real registration duties, address
              verification, travel, deadlines, or compliance, use SOLAR’s{" "}
              <InternalGuideLink to="/resources/registry-compliance-verification-guide">
                Registry Compliance & Verification Survival Guide
              </InternalGuideLink>{" "}
              to verify the actual duty through the correct state or local
              authority. If the contact becomes an actual police, registry,
              probation, parole, court, or CPS encounter, shift to{" "}
              <InternalGuideLink to="/resources/police-registry-cps-encounters">
          ...
          <DoDontJudgment
            ...
            judgment={[
              ...
              "If a real warrant, violation, or compliance problem may exist, consider counsel before giving detailed statements.",
            ]}
          />
...
I am taking notes. Could you please repeat your name or department so I can write it down correctly?`}
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              ...
              exclusion, or stigma. The pitch may promise{" "}
              <ExternalGuideLink href={sourceLinks.ftcRefundRecoveryScams}>
                “guaranteed removal,” “secret federal loopholes,” or a pay-us-to-fix-it recovery promise
              </ExternalGuideLink>
              . It may say “instant expungement,” “we know the registry office,”
              or “pay today or your listing will get worse.”
            </p>
          ...
          <DualDepthSection
            ...
            simple={
              <p>
                Do not pay for a promise until you can verify two different
                things: first, that the person, lawyer, or company is real and
                appropriately licensed; second, that the claimed legal remedy
                actually exists, applies in the relevant jurisdiction, and could
                plausibly apply to you.
              </p>
            }
            deepTitle="Why registry-relief promises need extra care"
            deep={
              <p>
                A real lawyer or real company does not automatically make a
                legal claim accurate. Expungement, sealing, pardon, termination,
                risk-level review, registration relief, and public-listing
                removal are different processes in different states. Some may
                not be available. Some may require a court order. Some may
                change criminal records but not registration duties. Treat broad
                promises as advertising, not authority.
              </p>
            }
          />
          ...
          <GuideCallout
            tone="legal"
            icon="⚖️"
            title="Verify the person and the remedy"
          >
            <p>
              Use a state bar or lawyer-licensing tool through a reliable legal
              help directory such as the{" "}
              <ExternalGuideLink href={sourceLinks.abaFindLegalHelp}>
                ABA Find Legal Help lawyer licensing resources
              </ExternalGuideLink>{" "}
              to verify the person. Then separately verify the claimed registry
              remedy through the relevant court, statute, state registry agency,
              attorney, or state-specific legal source. For state registry
              contacts, start with SOLAR’s{" "}
              <InternalGuideLink to="/resources/state-registry">
                State Registry Hub
              </InternalGuideLink>
              .
            </p>
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              ...
              realize you are documenting.{" "}
              <ExternalGuideLink href={sourceLinks.fbiImpersonationBoston}>
                Preserve communications and transaction records
              </ExternalGuideLink>{" "}
              first when it is safe.
            </p>
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              Platform rules are not the same as criminal law. For example, X
              has a specific{" "}
              <ExternalGuideLink href={sourceLinks.xPrivateInformation}>
                private-information and doxxing policy
              </ExternalGuideLink>
              , while Facebook, TikTok, and other platforms have their own
              reporting systems. Use the platform’s category that best fits the
              conduct, and save the report confirmation.
            </p>
          </GuideProse>
          ...
          <ResourceLinkGrid
            ...
            resources={[
              ...
              },
              {
                ...
                href: sourceLinks.xReportViolation,
                badge: "Platform",
                description: "Reporting pathway for violations on X.",
              },
              {
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              ...
              MFA apps may raise supervision questions. Verify with the{" "}
              <InternalGuideLink to="/resources/supervision-conditions-guide">
                Supervision Conditions Survival Guide
              </InternalGuideLink>{" "}
              before changing technology in a way that could affect compliance.
            </p>
          </GuideProse>
          ...
          <GuideCallout tone="info" icon="🧾" title="Where to report money and identity issues">
            <p>
              ...
              <ExternalGuideLink href={sourceLinks.ftcReportFraud}>
                ReportFraud.gov
              </ExternalGuideLink>
              . For identity theft recovery, use{" "}
              <ExternalGuideLink href={sourceLinks.identityTheft}>
                IdentityTheft.gov
              </ExternalGuideLink>
              . If money moved through a bank, card, wire, payment app, or
              transfer service,{" "}
              <ExternalGuideLink href={sourceLinks.ftcWhatToDoIfScammed}>
                contact that provider quickly
              </ExternalGuideLink>{" "}
              and save the claim number. For broader account and financial
              recovery planning, use SOLAR’s{" "}
              <InternalGuideLink to="/resources/financial-planning-guide">
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              ...
              <ExternalGuideLink href={sourceLinks.dojOvwStalking}>
                stalking
              </ExternalGuideLink>
              , harassment, extortion, vandalism, or a protective-order case.
              Those rules vary. But you can still document the pattern and ask
              the proper local office what the next step is.
            </p>
          </GuideProse>
          ...
          <GuideCallout tone="info" icon="🗂️" title="Use a pattern log">
            <p>
              For repeated unwanted contact, keep one{" "}
              <ExternalGuideLink href={sourceLinks.sparcDocumentationLog}>
                incident or documentation log
              </ExternalGuideLink>{" "}
              instead of scattered notes. Add new incidents, reports, photos,
              witnesses, and agency responses in the same place so the pattern
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              If family members or supporters are becoming secondary targets,
              pair this guide with SOLAR’s{" "}
              <InternalGuideLink to="/resources/family-support-guide">
                Family & Allies Guide
              </InternalGuideLink>
              . If landlord contact, lease pressure, eviction threats, or
              property damage become part of the harassment, use{" "}
              <InternalGuideLink to="/resources/tenant-rights">
                Tenant Rights
              </InternalGuideLink>
              . If the harassment causes immediate displacement or a shelter
              crisis, use the{" "}
              <InternalGuideLink to="/resources/housing-crisis-homelessness-disaster-survival-guide">
          ...
          <VerifyBeforeActing
            ...
            whoToAsk={
              <span>
                ...
                <ExternalGuideLink href={sourceLinks.rcfpRecordingGuide}>
          ...
          <PathwayCard
            ...
            whyItWorks={
              <p>
                ...
                handles internet-enabled fraud reports.{" "}
                <ExternalGuideLink href={sourceLinks.ftcReportFraud}>
                  ReportFraud.gov
                </ExternalGuideLink>{" "}
                handles consumer fraud.{" "}
                <ExternalGuideLink href={sourceLinks.identityTheft}>
                  IdentityTheft.gov
                </ExternalGuideLink>{" "}
                supports identity-theft recovery. Banks and payment services
                handle transaction disputes. The{" "}
                <ExternalGuideLink href={sourceLinks.uspisReport}>
          ...
          <PathwayCard
            ...
            whyItWorks={
              <p>
                ...
                can preserve footage or messages. A{" "}
                <ExternalGuideLink href={sourceLinks.usaStateConsumer}>
                  state consumer-protection office
                </ExternalGuideLink>{" "}
                may be appropriate for some local scam reports. Registry or
                supervision contacts may be needed only if the issue affects
                actual compliance. Counsel or{" "}
                <ExternalGuideLink href={sourceLinks.lscLegalHelp}>
                  legal aid
                </ExternalGuideLink>{" "}
                may be needed when legal risk is unclear.
              </p>
            }
            steps={[
          ...
          <ResourceLinkGrid
            ...
            resources={[
              ...
              },
              {
                ...
                badge: "FTC",
                description:
                  "Warnings about upfront-fee recovery promises and impostors who claim they can fix a problem for money.",
              },
              {
                label: "IdentityTheft.gov",
                href: sourceLinks.identityTheft,
              ...
              {
                label: "LSC — I need legal help",
                href: sourceLinks.lscLegalHelp,
                badge: "Legal aid",
                description:
                  "Find LSC-funded legal aid organizations near you by address or city.",
              },
            ]}
          />
        </GuideSectionCard>
        ...
        <GuideSectionCard>
          ...
          <GuideCallout tone="reminder" icon="🧭" title="When the suspected person has authority">
            <p>
              ...
              or counsel before making statements that could affect supervision,
              housing, employment, or safety. If search, questioning, consent,
              silence, or counsel issues arise, use SOLAR’s{" "}
              <InternalGuideLink to="/resources/know-your-rights">
                Know Your Rights
              </InternalGuideLink>{" "}
              guide.
            </p>
          ...
          <GuideChecklist
            ...
            items={[
              ...
              },
              {
                id: "appearance",
                label:
                  "Person appears at your home, work, school, treatment site, church, or family member’s location.",
              },
              {
                id: "weapon",
              ...
              },
              {
                id: "account-money",
                label:
                  "Account takeover, bank risk, payment loss, identity theft, or unauthorized transaction.",
              },
              {
                id: "extortion",
                label:
                  "Extortion or blackmail involving intimate, private, legal, employment, housing, or family information.",
              },
              {
                id: "vandalism",
                label:
                  "Vandalism, property targeting, vehicle damage, mail tampering, or escalating real-world conduct.",
              },
              {
                id: "false-report",
                label:
                  "False report or impersonation that could create arrest, registry, supervision, employment, or housing risk.",
              },
              {
                id: "official-confusion",
                label:
                  "Supervision, registry, court, or law-enforcement identity confusion that could affect compliance.",
              },
            ]}
          />
        </GuideSectionCard>
        ...
        <GuideSectionCard>
          <ResourceLinkGrid
            ...
            resources={[
              ...
              },
              {
                ...
                badge: "Scam pattern",
                description:
                  "Warnings about upfront-fee promises and impostors who claim they can recover or fix a problem for money.",
              },
              {
                label: "IdentityTheft.gov",
                href: sourceLinks.identityTheft,
              ...
              },
              {
                ...
                badge: "Legal aid",
                description:
                  "Find LSC-funded civil legal aid organizations near you.",
              },
              {
                label: "ABA Find Legal Help",
                href: sourceLinks.abaFindLegalHelp,
                badge: "Legal help",
                description:
                  "Lawyer referral, free legal help, and lawyer licensing resources.",
              },
            ]}
          />
          ...
          <RelatedGuides
            guides={[
              ...
              {
                title: "Housing Crisis, Homelessness & Disaster Survival Guide",
                description:
                  "Use when harassment, doxxing, threats, landlord contact, or displacement creates an immediate housing or shelter crisis.",
                to: "/resources/housing-crisis-homelessness-disaster-survival-guide",
              },
              {
