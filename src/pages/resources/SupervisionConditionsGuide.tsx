...
const sourceLinks = {
  ...
  sorna: "https://smart.ojp.gov/sorna",
  smartFaq: "https://smart.ojp.gov/faqs",
...
export default function SupervisionConditionsGuide(): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      <SEO
        ...
        description="Plain-language guide to probation, parole, supervised release, treatment rules, registry overlap, searches, violations, documentation, and safer communication with officers."
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <GuideSectionCard>
          ...
          <GuideProse>
            ...
            <p>
              ...
              parole agency or parole board.{" "}
              <strong>Federal supervised release</strong> usually starts after a
              federal prison sentence; it is not the same as federal parole.{" "}
              <strong>Pretrial release</strong> happens before conviction or
              final case outcome.
            </p>
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              <strong>
                When the consequence could be a violation, do not rely on vibes,
                memory, or someone else’s case.
              </strong>{" "}
              Check the written condition, ask the authority that controls the
              decision, and save proof of the answer. U.S. Courts publishes{" "}
              <a
                href={sourceLinks.standardConditions}
                className={linkClass}
                target="_blank"
          ...
          <GuideCallout
            tone="info"
            icon="🔎"
            title="Proof links for common high-risk topics"
          >
            <p>
              For federal supervision, U.S. Courts explains conditions about{" "}
              <a
                href={sourceLinks.travel}
                className={linkClass}
                target="_blank"
              ...
              . These federal pages are helpful references, but they do not
              replace your own court order, parole certificate, registry office,
              treatment contract, or attorney.
            </p>
          </GuideCallout>
        ...
        <GuideSectionCard>
          <GuideProse>
            ...
            <p>
              <strong>
                Treatment rules are not automatically criminal laws, but they
                can become supervision problems.
              </strong>{" "}
              That is especially true if your conditions require treatment,
