    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              After an arrest, families often need answers right away. A spouse
              may feel desperate for an explanation. Parents may want to ask what
              happened. The accused person may want to defend themselves,
              apologize, reassure people, correct misunderstandings, or be
              understood before everyone forms an opinion.
            </p>

            <p>
              Those feelings are real. But ordinary jail and prison calls,
              messages, mail, and video visits are dangerous places to process
              the case — especially in sex-offense-related cases where
              allegations may involve sexual conduct, minors, victim-related
              restrictions, no-contact rules, treatment restrictions, family
              conflict, or intense pressure to explain.
            </p>
          </GuideProse>
        ...
        <GuideSectionCard>
          ...
          <GuideProse>
            <p>
              Legal mail is different from ordinary mail, but it is not magic.
              It usually requires clear attorney identification, correct
              markings, and facility-specific handling. If legal mail is not
              marked or handled correctly, it may be treated as general
              correspondence.
            </p>
          </GuideProse>
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              Phone calls, electronic messaging, tablets, and video visits can
              help families stay connected, but they are built inside
              correctional systems. They may require approved contacts, account
              funding, vendor registration, identity checks, facility approval,
              message screening, time limits, and behavior rules.
            </p>
          </GuideProse>
        ...
        <GuideSectionCard>
          <GuideProse>
            <p>
              ...
              when a general visiting policy exists, the local institution may
              have its own visiting hours, dress code, approval process, visitor
              limits, child visitor rules, and cancellation practices.
            </p>
          </GuideProse>
...
I am not trying to argue. I just want to avoid repeating the same mistake.`}
        ...
        <GuideSectionCard>
          <SourceList
            note={
              <span>
                These official sources support the guide’s general federal
                communication, mail, phone, visiting, location, and special-mail
                guidance. State prisons, county jails, private facilities, and
                detention centers may use different vendors and rules. Always
                verify with the current facility before acting.
              </span>
            }
            sources={[
              {
                label:
                  "Bureau of Prisons — Community Ties: correspondence, telephone, email, visiting",
                href: sourceLinks.bopCommunications,
                description:
                  "Official BOP overview of communication options, including correspondence, phone, email, and visiting information.",
              },
              {
                label: "Bureau of Prisons — TRULINCS topics",
                href: sourceLinks.bopTrulincs,
                description:
                  "BOP page explaining the Trust Fund Limited Inmate Computer System and electronic messaging context.",
              },
              {
                label: "Bureau of Prisons — Visiting",
                href: sourceLinks.bopVisiting,
                description:
                  "Official BOP visiting overview and starting point for visiting rules and expectations.",
              },
              {
                label: "Bureau of Prisons — Find an inmate",
                href: sourceLinks.bopLocator,
                description:
                  "Official federal locator for people in BOP custody or previously in federal custody.",
              },
              {
                label: "Bureau of Prisons — Locations",
                href: sourceLinks.bopLocations,
                description:
                  "Official BOP facility directory for institution-specific contact information and local pages.",
              },
              {
                label:
                  "BOP Program Statement 5265.14 — Correspondence",
                href: sourceLinks.bopCorrespondencePolicy,
                description:
                  "Federal policy statement covering general correspondence and mail handling.",
              },
              {
                label:
                  "BOP Program Statement 5265.13 — TRULINCS",
                href: sourceLinks.bopTrulincsPolicy,
                description:
                  "Federal policy statement covering TRULINCS and electronic messaging rules.",
              },
              {
                label:
                  "BOP Program Statement 5264.08 — Inmate Telephone Regulations",
                href: sourceLinks.bopTelephonePolicy,
                description:
                  "Federal policy statement covering inmate telephone regulations and monitoring-related procedures.",
              },
              {
                label:
                  "BOP Program Statement 5267.09 — Visiting Regulations",
                href: sourceLinks.bopVisitingPolicy,
                description:
                  "Federal policy statement covering visiting regulations and institutional procedures.",
              },
              {
                label: "BOP Special Mail Notice",
                href: sourceLinks.bopSpecialMailNotice,
                description:
                  "BOP form explaining special mail notice procedures and marking requirements.",
              },
              {
                label: "BOP Visitor Information Form",
                href: sourceLinks.bopVisitorForm,
                description:
                  "BOP visitor information form used in the federal visiting approval process.",
              },
              {
                label: "USAGov — How to look up prisoners and prison records",
                href: sourceLinks.usaGovPrisonerRecords,
                description:
                  "Federal public guidance for finding prisoner records and locator resources.",
              },
            ]}
          />
        </GuideSectionCard>
