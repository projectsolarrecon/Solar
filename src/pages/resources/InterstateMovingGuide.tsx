    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <QuickStartPanel
          ...
          urgentActions={[
            <span>
              ...
              <strong>state supervision</strong>, or{" "}
              <strong>no supervision</strong>?
            </span>,
            <span>
        ...
        <GuideCallout
          tone="legal"
          icon="⚖️"
          title="This is a planning guide, not legal advice"
        >
          <p>
...
<GuideSectionHeader
            ...
            items={[
              {
                id: "status",
                label:
                  "Write down whether you are on federal supervision, state supervision, or no supervision.",
              },
              {
                id: "state-hub",
                label: (
        ...
        <GuideSectionCard>
          ...
          <GuideCallout
            tone="warning"
            icon="🏠"
            title="A lease is not the final answer"
          >
            <p>
