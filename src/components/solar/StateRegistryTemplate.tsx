...
/**
 * Optional SOLAR components (leave commented if you don’t use them yet):
 *
...
export interface StateRegistryData {
  ...
  travelInterstate?: string[];         // existing “Moving/relocation” content
  visitingTraveling?: string[];        // NEW: visitors, hotel stays, short-term presence
  ...
  // Plain-language layer (amber boxes)
  plainLanguage?: {
...
// Paragraph that supports inline [text](https://url) links
...
// Bullet list that supports inline [text](https://url) links
...
function SafeText({ text = "" }: { text?: string }) {
  ...
  // Replace [text](url) with anchor tags (http/https only)
